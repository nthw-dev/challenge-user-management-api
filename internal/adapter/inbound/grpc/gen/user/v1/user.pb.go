...
type User struct {
	...
	UpdatedAt     *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"` // There is deliberately no password field in this contract.
...
func (x *ListUsersResponse) GetMeta() *ListMeta {
	if x != nil {
		return x.Meta
	}
	return nil
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\x05limit\x18\x01 \x01(\x05H\x00R\x05limit\x88\x01\x01\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x12\x14\n" +
	"\x05query\x18\x03 \x01(\tR\x05queryB\b\n" +
	"\x06_limit\"_\n" +
	"\x11ListUsersResponse\x12#\n" +
	"\x05users\x18\x01 \x03(\v2\r.user.v1.UserR\x05users\x12%\n" +
	"\x04meta\x18\x02 \x01(\v2\x11.user.v1.ListMetaR\x04meta\"q\n" +
	"\bListMeta\x12\x14\n" +
	...
	"\n" +
	"DeleteUser\x12\x1a.user.v1.DeleteUserRequest\x1a\x1b.user.v1.DeleteUserResponseBZZXgithub.com/nthw-dev/user-management-api/internal/adapter/inbound/grpc/gen/user/v1;userv1b\x06proto3"
...
var file_user_v1_user_proto_goTypes = []any{
	...
	(*ListMeta)(nil),              // 7: user.v1.ListMeta
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	7,  // 5: user.v1.ListUsersResponse.meta:type_name -> user.v1.ListMeta
	...
	8,  // 10: user.v1.UserService.UpdateUser:input_type -> user.v1.UpdateUserRequest
	10, // 11: user.v1.UserService.DeleteUser:input_type -> user.v1.DeleteUserRequest
